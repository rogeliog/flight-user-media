define(function (require) {
  ...
  function userMedia(withFilters) {
    ...
    this.nativeEvents = ['abort', 'canplay', 'canplaythrough', 'durationchange', 'emptied', 'ended', 'error', 'loadeddata', 'loadedmetadata', 'loadstart', 'pause', 'play', 'playing', 'progress', 'ratechange', 'seeked', 'seeking', 'stalled', 'suspended', 'timeupdate', 'volumechange', 'waiting'];
    ...
    this.takeSnapshot = function (ev, data) {
      ...
      canvas.width = this.selector().clientWidth;
      canvas.height = this.selector().clientHeight;
      canvas.getContext('2d').drawImage(this.selector(), 0, 0);
    ...
    this.selector =  function () {
      return document.querySelector(this.attr.selector);
    };
    ...
    this.after('initialize', function () {
      ...
      if (navigator.getUserMedia) {
        ...
        this.nativeEvents.forEach(function (nativeEvent) {
